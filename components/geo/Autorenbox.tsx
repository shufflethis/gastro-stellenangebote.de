  ...
  return (
    <div className="autorenbox">
      ...
      <p className="autorenbox-bio">
        Thomas Sander ist der Gruender von gastro-stellenangebote.de. Mit jahrelanger Erfahrung im
        Bereich Gastro und Personalwesen hat er dieses spezialisierte Jobportal
        ins Leben gerufen, um Arbeitgeber und qualifizierte Fachkraefte zusammenzubringen.
      </p>
      <div className="autorenbox-links">
        <a href="https://gastro-stellenangebote.de/autor/thomas-sander">Mehr ueber den Autor</a>
      </div>
    </div>
  );
};
