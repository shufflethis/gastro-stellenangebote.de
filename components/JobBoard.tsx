  ...
  return (
    <section id="jobs" className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col">
        ...
        {/* Job Listings Header - shown first on mobile */}
        <div className="flex justify-between items-end mb-8 order-1">
          <div>
        ...
        {/* Job Cards Grid - shown prominently on mobile */}
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 order-2 mb-10">
        ...
        <div className="text-center sm:hidden order-3 mb-10">
           <a href="#" className="text-brand-600 font-medium hover:text-brand-700">
            Alle Jobs anzeigen &rarr;
          </a>
        </div>

        {/* AI Assistant Section - below jobs on mobile */}
        <div className="mb-8 bg-brand-50 border border-brand-100 rounded-2xl p-8 md:p-10 shadow-sm order-4">
          <div className="md:flex gap-8 items-start">
            <div className="flex-1">
              ...
              <p className="text-gray-600 mb-6">
                Unsicher, welcher Gastro-Job zu Dir passt? Beschreibe Deine Staerken, Vorlieben und Erfahrungen,
                und unsere KI findet die perfekte Rolle fuer Dich.
              </p>
              <div className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  placeholder="Z.B. 'Ich bin nachtaktiv, liebe laute Musik und mixe gerne Getraenke...'"
