        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><button onClick={() => setIsImpressumOpen(true)} className="hover:text-brand-500 transition text-left">Impressum</button></li>
                <li><a href="#" className="hover:text-brand-500 transition">Datenschutz</a></li>
